...
static msg_t wifiDLFile_thd(void * args) {
    ...
    EventListener eventWifiReceptionEndLst;
    chEvtRegisterMask(&eventWifiReceptionEnd, &eventWifiReceptionEndLst, 1);
