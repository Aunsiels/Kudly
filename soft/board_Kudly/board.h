 ...
 * Port A setup.
 *
 * PA0  - GPIOA_LED1_R            (input floating).
 * PA1  - GPIOA_LED1_G            (alternate 11).
 * PA2  - GPIOA_LED1_B            (alternate 11).
 * PA3  - GPIOA_3                 (input floating).
 * PA4  - GPIOA_CAMERA_SYNC       (input pull-up).
 * PA5  - GPIOA_HAND_SENSOR_OUT   (output push-pull).
 * PA6  - GPIOA_CAMERA_PIXCLK     (input pull-up).
 * PA7  - GPIOA_7                 (alternate 11).
 * PA8  - GPIOA_CAMERA_XCLK       (alternate 0).
 * PA9  - GPIOA_USB_VBUS          (input pull-up).
...
#define VAL_GPIOA_PUPDR     (PIN_PUDR_PULLUP(GPIOA_CAMERA_SYNC) |           \
                             PIN_PUDR_PULLUP(GPIOA_CAMERA_PIXCLK) |         \
                             PIN_PUDR_PULLDOWN(GPIOA_USB_VBUS) |            \
                             PIN_PUDR_PULLUP(GPIOA_10) |                    \
                             PIN_PUDR_PULLDOWN(GPIOA_SWCLK))
#define VAL_GPIOA_ODR       0xFFFFFFDF
#define VAL_GPIOA_AFRL      (PIN_AFIO_AF(GPIOA_LED1_G, 11) |                \
                             PIN_AFIO_AF(GPIOA_LED1_B, 11) |                \
