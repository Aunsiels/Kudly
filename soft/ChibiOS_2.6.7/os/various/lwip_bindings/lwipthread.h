...
#define LWIP_IPADDR(p)                      IP4_ADDR(p, 137,194,43,47)
#endif

/** @brief IP Gateway. */
#if !defined(LWIP_GATEWAY) || defined(__DOXYGEN__)
#define LWIP_GATEWAY(p)                     IP4_ADDR(p, 137,194,42,254)
#endif

/** @brief IP netmask. */
#if !defined(LWIP_NETMASK) || defined(__DOXYGEN__)
#define LWIP_NETMASK(p)                     IP4_ADDR(p, 255, 255, 254, 0)
#endif
...
extern "C" {
  ...
  extern const struct netif * my_netif;
#ifdef __cplusplus
}
#endif
